package com.prashantb.twitterconnect;
...
public class MainActivity extends Activity {
	 ...
	 * */
	static String TWITTER_CONSUMER_KEY = "your consumer key"; // place
																		// your
																		// cosumer
																		// key
																		// here
	static String TWITTER_CONSUMER_SECRET = "your secrete key"; // place
																									// your
																									// consumer
																									// secret
																									// here
	 ...
	 * */
	class bgLoginToTwitter extends AsyncTask<Void, Void, Void> {
	...
	class bgTask extends AsyncTask<Void, Void, AccessToken> {

		@Override
		protected AccessToken doInBackground(Void... arg0) {
			Log.d("ok", "" + isTwitterLoggedInAlready());
			if (!isTwitterLoggedInAlready()) {
